...
export const experiencesData = [
  {
    ...
    description: [`Working in Frontend with ReactJS, NextJS, React-Query, Context, Redux and various other Frontend libraries.`,
  ...
  },
  {
    ...
    location: "Remote",
    description: [`Worked in Frontend and Backend to develop the StepUp Analytics EdTech website.`,
...
export const projectsData = [
  {
    title: "MusicRoom",
    description:
      `A website where different users can login, create and join different rooms. Users can chat with each other and
