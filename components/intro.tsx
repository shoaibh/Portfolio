...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="relative mb-10 mt-4 px-4 text-2xl text-white font-medium !leading-[1.5] sm:text-4xl"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold">Hello, I am Shoaib Hamza.</span> I am a{" "}
        <span>Frontend developer</span> with <span>3+ years</span> of experience
        working with Reactjs, Nextjs and other frontend technologies.
      </motion.h1>

      <motion.div
        className="relative flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
